...
def consult_rag_llm_with_history(question, model_name="llama3.2:latest"):
    ...
    prompt = ChatPromptTemplate.from_template(
        f"""
        You are a helpful AI-powered disease diagnostic system in a rural clinic.
        Please answer based on the provided context and previous conversation history.
